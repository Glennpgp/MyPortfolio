          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between">
            ...
            <div className="w-full md:w-3/5 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl max-w-xl text-gray-300">
                Hi there! I'm a software developer with a curious mind, eager to explore new and exciting challenges 
                with a problem solving mindset. In this fast paced technological world, I am continuously working 
                with new tools to find efficient ways to build robust software.
              </p>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">React</span>
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">IoT</span>
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">WebSockets</span>
                    </div>
                  </div>
                </Link>
              </div>
              ...
              <div className="group bg-gray-800/60 backdrop-blur-md hover:bg-gray-700/80 rounded-xl overflow-hidden transition-all duration-500 hover:scale-[1.02]">
                <div className="block">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">Next.js</span>
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">Firebase</span>
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">Tailwind</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-gray-800/60 backdrop-blur-md hover:bg-gray-700/80 rounded-xl overflow-hidden transition-all duration-500 hover:scale-[1.02]">
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">Next.js</span>
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">MongoDB</span>
                      <span className="text-xs px-3 py-1 rounded-full bg-gray-700">REST API</span>
                    </div>
                  </div>
                </Link>
              </div>
